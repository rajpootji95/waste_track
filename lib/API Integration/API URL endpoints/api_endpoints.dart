class Endpoints {
 ...
 // static const String baseUrl = "http://matchitsports.com:4000/api/";
  ...
  static const String updateVendorStatus = "vendor/update-vendor-status";
  ...
  static const String areaAssignList =  'area/assign-area';
  ...
  /// receiveTimeout
  static const Duration receiveTimeout = Duration(milliseconds: 15000); // 15000;

  /// connectTimeout
  static const Duration connectionTimeout = Duration(milliseconds: 15000); //15000;
}
