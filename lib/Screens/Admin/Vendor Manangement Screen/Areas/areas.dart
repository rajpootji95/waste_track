...
class _AreasState extends State<Areas> with SingleTickerProviderStateMixin {
  ...
  Future<void> _fetchData() async {
    ...
    if (!isLoadingMoreData && addAreaController?.getAreaModel?.data.length != addAreaController?.getAreaModel?.pagination?.totalItems ) {
      ...
      addAreaController?.getAreaApi(context,"1", '$limit','',status).then(
              (value){
    ...
    tabController.addListener(() {
      if (tabController.indexIsChanging == false) {
        if (tabController.index == 1) {
          ...
          status = "0";
          addAreaController?.getAreaApi(context, "1", "10", "",status);
        } else {
           status = "1";
          addAreaController?.getAreaApi(context, "1", "10", "",status);
        }
              ...
              floatingActionButton: FloatingActionButton(
                ...
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => AddArea())).then((value){
                    controller.getAreaApi(context, "1", "10", "",status);
                  });
                },
              ),
              body: Padding(
                        ...
                        children: [
                          Flexible(
                            child: CustomSearchTextField(
                              onChanged: (value){
                                debugPrint(value);
                                controller.getAreaApi(context, "1","10",value,status);
                              },
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: ScrollConfiguration(
                                      ...
                                      controller.getAreaModel!.data.isEmpty?
                                      Center(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Row(
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        GestureDetector(
                                                                                          onTap: () {
                                                                                            controller.deleteAreaApi(areaList.id ?? "","0").then((value){controller.getAreaApi(context,"1", "10","","0");});
                                                                                            Navigator.pop(context);
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Row(
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        GestureDetector(
                                                                                          onTap: () {
                                                                                            controller.deleteAreaApi(areaList.id ?? "",status).then((value){controller.getAreaApi(context,"1", "10","",status );});
                                                                                            Navigator.pop(context);
