        ...
        children: [
            ...
            children: [
              Flexible(
                child: CustomSearchTextField(
                  onChanged: (v){
                    allotedController.getOrderListApi(context, "1", "",v,widget.vendorId).then((value) {
                      setState(() {
          ...
          Flexible(
            child: ScrollConfiguration(
              behavior: MyBehavior(),
              child:allotedController.getOrderModel?.data == null ?myShimmer():
              allotedController.getOrderModel?.data.length == 0 ?
              Center(child: Text("No purchase history !!")): ListView.builder(
