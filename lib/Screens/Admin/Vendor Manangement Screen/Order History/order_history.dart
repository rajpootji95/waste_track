...
class _OrderHistoryState extends State<OrderHistory> {
  ...
  debugPrint("sjgdjhcdjhdgfhdg ${ controller.getVendorOrdersModel?.data.length}");
        ...
        children: [
              ...
              children: [
                Flexible(
                  child: CustomSearchTextField(
                    ...
                    onChanged: (v){
                      controller.getVendorOrdersApi(context, "1", "10",v).then((value) {
                        setState(() {
          ...
          Flexible(
            child: ScrollConfiguration(
              behavior: MyBehavior(),
              child:
              controller.getVendorOrdersModel?.data == null ?
              myShimmer():
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                ...
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>OrderHistoryDetails(orderId: orderHistory?.id))).then((value){
                                  callGetVendorCountApi();
                                });
                              },
                              child: Visibility(
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(20),
                                  color: orderHistory?.orderStatusText == "Pending" ? AppColor.orange.withOpacity(0.3) : orderHistory?.orderStatusText == "Cancelled" ?AppColor.redLight.withOpacity(0.3) :orderHistory?.orderStatusText == "Confirmed" ?AppColor.green.withOpacity(0.3) : AppColor.purpleLight.withOpacity(0.3)
                                  //AppColor.orange.withOpacity(0.3)
                              ),
                              child: Text(
                                '${orderHistory?.orderStatusText}',
                                style:
                                    TextStyle(fontSize: 11, color:orderHistory?.orderStatusText == "Pending" ? AppColor.orange : orderHistory?.orderStatusText == "Cancelled" ?AppColor.redLight :orderHistory?.orderStatusText == "Confirmed" ?AppColor.green : AppColor.purpleDark ) ,
                              ),
                            ),
                          ),
                        ],
