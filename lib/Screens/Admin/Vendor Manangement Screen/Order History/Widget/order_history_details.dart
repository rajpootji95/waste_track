...
class _OrderHistoryDetailsState extends State<OrderHistoryDetails> {
  ...
  void dispose() {
    ...
    super.dispose();
    controller.getVendorOrderDetailsModel = null;
  }
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:
      controller.getVendorOrderDetailsModel == null? myShimmer():
      controller.getVendorOrderDetailsModel!.data == null ?
      Text("No Order Details !!") : Padding(
          ...
          child: ListView(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  controller.getVendorOrderDetailsModel?.data?.orderStatusText == 'Cancelled' ? SizedBox.shrink(): GestureDetector(
                    onTap: (){
                      if(controller.getVendorOrderDetailsModel?.data?.orderStatusText == 'Completed'){
                        return;
                      }
                      controller.orderConfirmApi(widget.orderId ?? "",controller.getVendorOrderDetailsModel?.data?.orderStatus,context).then((value)async {
                        await controller.getVendorOrdersDetailsApi(context,widget.orderId);
                        setState(() {});
                      });
                    },
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          color: controller.getVendorOrderDetailsModel?.data?.orderStatusText == 'Completed'?AppColor.purpleLight.withOpacity(0.5):AppColor.greenLight.withOpacity(0.3)),
                      child: Row(
                        children: [
                          SvgPicture.asset(
                            controller.getVendorOrderDetailsModel?.data?.orderStatusText == 'Completed' ?AppImages.request_com:AppImages.order_approve,
                            height: 18,
                        ...
                        controller.isLoading ? CupertinoActivityIndicator(): Text(
                            ...
                            'Confirm Order',
                            style:
                            TextStyle(color: controller.getVendorOrderDetailsModel?.data?.orderStatusText == 'Completed'?AppColor.purpleDark:AppColor.green , fontSize: 14),
                          ),
                        ],
                      ),
                    ),
                          ...
                          Row(
                            children: [
                              Icon(
                                Icons.circle,
                                size: 14,
                                color: controller.getVendorOrderDetailsModel?.data?.orderStatusText == "Pending" ? AppColor.orange : controller.getVendorOrderDetailsModel?.data?.orderStatusText == "Cancelled" ?AppColor.redLight :controller.getVendorOrderDetailsModel?.data?.orderStatusText == "Confirmed" ?AppColor.green : AppColor.purpleDark,
                              ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          const SizedBox(
                           ...
                           Text(
                            " ${controller.getVendorOrderDetailsModel?.data?.vendorInfo?.firstName} ${controller.getVendorOrderDetailsModel?.data?.vendorInfo?.lastName}",
                            style: TextStyle(
                                color: AppColor.black,
                                fontSize: 13,
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Flexible(
                                  flex: 2,
                                  child: Text("${orderSharingList!.companyName}\n(${orderSharingList.sharingPercentage}${orderSharingList.sharingPercentage == 1000?"/roll":'%'})",
                                      style: TextStyle(
                                          fontFamily: AppFont.poppinsRegular,
                                          fontSize: 12)),
                                ),
