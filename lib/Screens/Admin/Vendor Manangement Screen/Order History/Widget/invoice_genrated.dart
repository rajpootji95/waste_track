        ...
        child: ScrollConfiguration(
          ...
          child: ListView(
            children: [
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Company Address, ${controller.getVendorOrderDetailsModel?.data?.invoiceFrom?.companyAddress} ",
                          style: TextStyle(
                              fontFamily: AppFont.poppinsRegular,
                              fontSize: 13)),
                      SizedBox(
                      ...
                      Text("(+234) ${controller.getVendorOrderDetailsModel?.data?.invoiceFrom?.phoneNumber}",
                          style: TextStyle(
                              fontFamily: AppFont.poppinsRegular,
                              fontSize: 13)),
                      SizedBox(
                      ...
                      Text("${controller.getVendorOrderDetailsModel?.data?.invoiceFrom?.email}",
                          style: TextStyle(
                              fontFamily: AppFont.poppinsRegular,
                              fontSize: 13)),
                      SizedBox(
              ...
              Text("Bank name: ${controller.getVendorOrderDetailsModel?.data?.bankInfo?.bankName}",
                  style: TextStyle(
                      fontFamily: AppFont.poppinsRegular, fontSize: 13)),
              SizedBox(
                height: 5,
              ),
              Text("SWIFT/IBAN: ${controller.getVendorOrderDetailsModel?.data?.bankInfo?.iban}",
                  style: TextStyle(
                      fontFamily: AppFont.poppinsRegular, fontSize: 13)),
              SizedBox(
                height: 5,
              ),
              Text("Account number: ${controller.getVendorOrderDetailsModel?.data?.bankInfo?.accountNumber}",
                  style: TextStyle(
                      fontFamily: AppFont.poppinsRegular, fontSize: 13)),
              SizedBox(
                height: 5,
              ),
              Text("Please use ${controller.getVendorOrderDetailsModel?.data?.referenceNo} as a reference number",
                  style: TextStyle(
                      fontFamily: AppFont.poppinsRegular, fontSize: 13)),
              SizedBox(
                height: 20,
