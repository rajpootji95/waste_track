    ...
    return GetBuilder(
      init: WasteManagementAgencyController(context: context),
        ...
        Scaffold(
          ...
          body:controller.wasteModel == null?
          Center(child: myShimmer())
              :controller.wasteModel?.data == null?Center(child: Text("No waste agency not found !!")) : Obx(() {
              return
                 Container(
                            ...
                            children: [
                              Flexible(
                                child: CustomSearchTextField(
                                  onChanged: (v){
                                    controller.getWasteStaffApi(context, v).then((value){
                                      setState(() {
                                      });
                                    });
                                      ...
                                      if((controller.wasteModel?.status ?? false)){
                                        if(formKey.currentState!.validate()) {
                                          ...
                                          controller.addWasteStaffApi(
                                             ...
                                             controller.wasteModel!.data!.id, context,).then((value) {
                                               controller.getWasteStaffApi(context, "searchText");
                                               setState(() {
