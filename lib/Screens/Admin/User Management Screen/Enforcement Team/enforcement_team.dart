 ...
 @override
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      builder: (controller)=>
        Scaffold(
          floatingActionButton: controller.enforcementModel?.data == null?FloatingActionButton(
          ...
          myShimmer()
              :controller.enforcementModel?.data == null?
          Center(child: Text("Enforcement team not found")) :
          Padding(
                                ...
                                _image != null
                                  ...
                                  fit: BoxFit.cover,
                                    ...
                                    borderRadius: BorderRadius.circular(100),
                                      child: Image.network("${controller.enforcementModel?.data?.imageBaseUrl}${controller.enforcementModel!.data!.imageName}",
                                  fit: BoxFit.cover,
