...
class _NylonProductionCompanyState extends State<NylonProductionCompany> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      ...
      builder: (controller) =>
      Scaffold(
         floatingActionButton:  controller.nylonModel?.data == null ?FloatingActionButton(
        ...
        Center(child: myShimmer())
            :controller.nylonModel?.data == null?  Center(child: Text("Nylon production company not found")) : Padding(
