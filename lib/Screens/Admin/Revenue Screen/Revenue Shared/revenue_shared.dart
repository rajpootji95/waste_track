...
class _RevenueSharedState extends State<RevenueShared> {
  ...
  Future<void> _fetchData() async {
    ...
    if (!isLoadingMoreData &&
      ...
      revenueController.getRevenueShareListApi(context, "1", '$limit', '', revenueController.getRevenueShareAllModel!.data[selectedWidgetIndex].id)
          .then((value) {
                  ...
                  child: CustomSearchTextField(
                    onChanged: (v) {
                      controller.getRevenueShareListApi(
                          context, "1", "10",v,controller.getRevenueShareAllModel!.data[selectedWidgetIndex].id).then((value){
                         setState(() {
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: ScrollConfiguration(
                        behavior: MyBehavior(),
                        child:controller.getRevenueShareAllModel == null? myShimmer(): ListView.builder(
