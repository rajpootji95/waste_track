...
import '../../../Waste Management Agency/Was Agency Nylon Management/Widget/was_agency_nylon_man_details.dart';
...
class _NylonDetailsState extends State<NylonDetails>
  ...
  Future<void> _fetchData1() async {
    int currentDataLength = nylonDetailsController.getNylonDetailsAssignedModel?.data.length??0;
    debugPrint("fetchData called!!!!!  ${nylonDetailsController.getNylonDetailsAssignedModel?.data.length}");
    if (!isLoadingMoreData && nylonDetailsController.getNylonDetailsAssignedModel?.data.length != nylonDetailsController.getNylonDetailsAssignedModel?.pagination?.totalItems ) {
      int limit = currentDataLength + 10;
      setState(() {
        isLoadingMoreData = true;
      });
  ...
  void _onScroll() {
    ...
    if (_scrollController.position.pixels ==
      ...
      if(nylonDetailsController.isGeneratedDetails){
        _fetchData();
      } else{
        _fetchData1();
      }
                      ...
                      children: [
                        Flexible(
                          child: CustomSearchTextField(
                            onChanged: (value){
                              controller.getNylonDetailsApi(context, status, "1", "10", value).then((value){
                                setState(() {
                                              ...
                                              children: [
                                                Stack(
                                                  children: [
                                                    ...
                                                    Positioned(
                                                      ...
                                                      child: GestureDetector(
                                                        onTap: () {
                                                          Navigator.push(
                                                              context,
                                                              MaterialPageRoute(builder: (context)=>GeneratedDetails(batchId: nylonDetailAssigned?.id,batchNumber: nylonDetailAssigned?.batchNumber,)));
                                                        },
                                                        child: Visibility(
                                                          visible: controller.nylonDetailsVisibilityController
                                                              .areOptionVisibleList[index],
                                                    ...
                                                    Positioned(
                                                      ...
                                                      child: GestureDetector(
                                                        onTap: () {
                                                          controller.getNylonBatchIdsDownloadUrlApi([nylonDetailAssigned?.id??'']);
                                                          //  controller.downLoadFile("", controller.getNylonDetailsGeneratedModel?.data[index].id);
                                                        },
                                                        child: Visibility(
                                                            visible: controller.nylonDetailsVisibilityController
                                                ...
                                                GestureDetector(
                                                  onTap: () {
                                                    ...
                                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>WasAgencyNylonManagementDetails(batchNumber: controller.getNylonDetailsAssignedModel?.data[index].batchNumber,vendorId: controller.getNylonDetailsAssignedModel?.data[index].vendorId)));
                                                  },
                                                  child: Padding(
                                                    padding:
                                                ...
                                                if(index == (controller.getNylonDetailsAssignedModel?.data.length??0)-1  && isLoadingMoreData && (controller.getNylonDetailsAssignedModel?.data.length != controller.getNylonDetailsAssignedModel?.pagination?.totalItems))
                                                  Padding(
                                                    padding: const EdgeInsets.all(8.0),
                                                    child: CircularProgressIndicator(color:AppColor.green),
                                                  )
