...
class _ScannerButtonState extends State<ScannerButton> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        padding: EdgeInsets.all(widget.loginScreen??false?10.0:13),
        ...
        child: Row(
          ...
          children: [
            Icon(
              widget.loginScreen??false?Icons.qr_code_scanner_rounded:Icons.upload_file_outlined,
              color: Colors.white,
            ),
            SizedBox(
              width: 7,
            ...
            Text(
              widget.loginScreen??false?"Verify Nylon":'Upload Collected Nylon',
              style: TextStyle(
                color: Colors.white,
