          ...
          children: [
              ...
              children: [
                Flexible(
                  child: CustomSearchTextField(
                    controller: searchC,
                    onChanged: (value){
                      nylonManagementController.getNylonDetailsApi(context, "1", "10", value,).then((value) {
                        setState(() {
                    ...
                    suffixIcon:searchC.text.isEmpty ? Icon(
                      Icons.search,
                      color: AppColor.green,
                    ):InkWell(
                      onTap: (){
                        searchC.clear();
                        nylonManagementController.getNylonDetailsApi(context, "1", "10", "",).then((value) {
                          setState(() {
            ...
            Flexible(
              child: ScrollConfiguration(
                behavior: MyBehavior(),
                child:nylonManagementController.getNylonDetailsAssignedModel == null ?myShimmer():nylonManagementController.getNylonDetailsAssignedModel?.data.length == 0 ? Center(child: Text("Nylon List Not Found !!")) : ListView.builder(
